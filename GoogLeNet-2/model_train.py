...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    torch.save(best_model_wts, "C:/Users/admin/Desktop/CNN/GoogLeNet-2/best_model.pth")
...
def matplot_acc_loss(train_process):
    ...
    plt.plot(epochs, val_loss, "bs-", label="Val loss")
    plt.legend()
    plt.xlabel("epoch")
    plt.ylabel("Loss")
    ...
    # 绘制准确率曲线
    plt.subplot(1, 2, 2)
    plt.plot(epochs, train_acc, "ro-", label="Train acc")
    plt.plot(epochs, val_acc, "bs-", label="Val acc")
    plt.xlabel("epoch")
    plt.ylabel("Accuracy")
    plt.legend()
